    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/30">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose max-w-none text-slate-600">
          <p>By using this website, you agree to use it for legitimate e-commerce calculations only.</p>
          <p className="mt-4">This is a free tool provided as-is for educational and business purposes.</p>
        </div>
      </div>
    </main>
  );
