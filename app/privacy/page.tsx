    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/30">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose max-w-none text-slate-600">
          <p>We respect your privacy. This website does not collect any personal data.</p>
          <p className="mt-4">All calculators run locally in your browser. No data is sent to our servers.</p>
        </div>
      </div>
    </main>
  );
